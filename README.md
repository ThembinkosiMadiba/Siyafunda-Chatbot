...
👉 **[Chat with Siyafunda now](https://cdn.botpress.cloud/webchat/v3.6/shareable.html?configUrl=https://files.bpcontent.cloud/2026/04/24/06/20260424062817-9IPEK6QN.json)**
...
- ✅ Simplify complex AI concepts for beginners
- ✅ Enhance understanding using interactive conversation flows
- ✅ Support self-paced, personalised learning
- ✅ Make AI education fun, engaging, and accessible to all
...
| 🧠 Module 2 | ML, Deep Learning & Neural Networks |
...
### AI Ethics
- AI Bias — causes, examples, and solutions
...
| **JavaScript** | Execute Code nodes for logic |
| **Bot Variables** | Progress tracking and personalisation |
...
1. Click the **[Live Chatbot link](https://cdn.botpress.cloud/webchat/v3.6/shareable.html?configUrl=https://files.bpcontent.cloud/2026/04/24/06/20260424062817-9IPEK6QN.json)**
2. Select your user type (Student / Professional / Developer / Just Curious)
3. Browse the syllabus and pick a module to start learning
4. Ask questions freely using the AI assistant
...
User opens chatbot
        ↓
Welcome message + user type selection
        ↓
Personalised greeting based on user type
        ↓
Syllabus displayed with progress tracker
        ↓
User selects a module
        ↓
Module content + AI assistant for questions
        ↓
Module completion + congrats message
        ↓
Return to syllabus (progress updates)
        ↓
All 5 modules complete?
    YES → Ethics quiz → Certificate 🏆
    NO  → Back to syllabus to continue
```
...
*Built with 💙 by FanTechStic 5 x CAPACITI*
